  ...
  if (videos.length === 0) {
    return (
      <div className="h-[100dvh] w-full bg-black flex flex-col items-center justify-center px-6 text-center">
        <div className="w-16 h-16 rounded-full bg-leva-accent/15 flex items-center justify-center mb-5">
        ...
        <Link
          href="/upload"
          className="mt-8 px-6 py-3 bg-leva-accent hover:bg-leva-accent/80 text-black font-bold rounded-xl transition-colors"
        >
          Carica video
        </Link>
        <Link
