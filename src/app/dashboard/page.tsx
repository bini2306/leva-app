...
export default async function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-leva-bg flex flex-col px-6 py-12">
      <span className="text-leva-accent font-black text-2xl tracking-tight mb-12">
        LEVA
      </span>
      ...
      <div className="flex-1">
        ...
        <span className="inline-block mt-3 px-3 py-1 bg-leva-accent/15 text-leva-accent text-sm font-medium rounded-full">
          {roleLabel}
        </span>
        ...
        <div className="mt-10 space-y-3">
          ...
          >
            <div className="flex items-center gap-4">
              <div className="w-11 h-11 bg-leva-accent/15 rounded-xl flex items-center justify-center">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="w-5 h-5 text-leva-accent">
